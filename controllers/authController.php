...
if (isset($_POST['create_account'])) {
    ...
    if (empty($_POST['channel_name'])) {
        $errors['channel_name'] = 'channel name required';
    }
    ...
    $password = password_hash($_POST['spassword'], PASSWORD_DEFAULT); //encrypt password
...
if (isset($_POST['login'])) {
    if (empty($_POST['lusername'])) {
        $errors['lusername'] = 'Username or email required';
    }
